...
$it_managers = $it_manager->all_it_manager_request();
?>
...
<div class="table-responsive">
    <table id="tbl_req_status" class="table table-hover table-bordered">
        ...
        <tbody>
            <?php $snn=0; foreach ($it_managers as $it): $snn++; ?>
            <tr>
                <td><?= $snn; ?></td>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="button-list">
                                <button type="button" onclick="approveITManagerRequest('<?= $it['applicantID']; ?>');" class="btn btn-sm btn-success">Approve</button>
                                <button type="button" onclick="rejectITManagerRequest('<?= $it['applicantID']; ?>');" class="btn btn-sm btn-danger">Reject</button>
                            </div>
                        </div>
                    </div>
                </td>
