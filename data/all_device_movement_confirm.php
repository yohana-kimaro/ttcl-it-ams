...
$it_movement_confirm = $movement_storage->all_staff_movement_confirm();
?>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="button-list">
                                <button type="button" onclick="confirmMovemRequest('<?= $it['movedFromApplicantID']; ?>');" class="btn btn-sm btn-success">Confirm</button>
