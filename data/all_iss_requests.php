...
$it_support_supervisors = $it_support_supervisor->all_it_support_supervisor_requests();
?>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="button-list">
                                <button type="button" onclick="verifyITSSRequest('<?= $it['applicantID']; ?>');" class="btn btn-sm btn-success">Verify</button>
                                <button type="button" onclick="rejectITSSRequest('<?= $it['applicantID']; ?>');" class="btn btn-sm btn-danger">Reject</button>
                            </div>
                        </div>
                    </div>
                </td>
