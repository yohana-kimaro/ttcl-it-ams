...
$toner_allocations = $toner_request->all_toner_staff_confirmation();
?>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="button-list">
                                <button type="button" onclick="confirmTonerStaffAlloc('<?= $it['tonerApplID']; ?>');" class="btn btn-sm btn-success">Confirm</button>
                            </div>
                        </div>
                    </div>
                </td>
