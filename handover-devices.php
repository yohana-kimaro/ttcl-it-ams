...
<head>
    ...
    <title>TTCL IT AMS | Handover devices</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Handover device</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="paperclip"></i></span></span>Handover your device</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <div id="all-handover-device-req">
