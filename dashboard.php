...
<head>
    ...
    <title>TTCL IT AMS | Dashboard</title>
                            ...
                            <ul id="dash_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="allocated-toner-cartridges.php">View allocated toner cartridges</a>
                                        </li>
                                        <li class="nav-item">
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="aperture"></i></span></span>Dashboard</h4>
                </div>
                <!-- /Title -->
