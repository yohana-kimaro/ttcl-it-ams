...
<head>
    ...
    <title>TTCL IT AMS | List of IT Devices</title>
                                ...
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item active">
                                            ...
                                            <ul id="signup_drp1" class="nav flex-column collapse show collapse-level-2">
                                                <li class="nav-item">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item">
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="#">Mantained devices</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All mantained scanners</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="link"></i></span></span>All mantained scanners.</h4>
                </div>
                <!-- /Title -->
