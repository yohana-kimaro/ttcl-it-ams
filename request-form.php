...
<head>
    ...
    <title>TTCL IT AMS | Request form</title>
...
<body>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="command"></i></span></span>Application form</h4>
                </div>
                <!-- /Title -->
    ...
    <script type="text/javascript">
        function showDiv(select){
            ...
            }else if(select.value == "Replacement"){
                document.getElementById('replacement').style.display = "block";
                document.getElementById('lost').style.display = "none";
            }else if(select.value == "New employee"){
                document.getElementById('replacement').style.display = "none";
                document.getElementById('lost').style.display = "none";
            }
        }
    ...
    <script src="dist/js/filelimit.js"></script>
