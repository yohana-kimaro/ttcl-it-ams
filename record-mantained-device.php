...
if ($_SESSION['userpf@ttclassetsystem'] === 91019 || $_SESSION['userpf@ttclassetsystem'] === 91024 || $_SESSION['userpf@ttclassetsystem'] === 90820 || $_SESSION['userpf@ttclassetsystem'] === 91119 || $_SESSION['userpf@ttclassetsystem'] === 90914) {
} else {
...
<head>
    ...
    <title>TTCL IT AMS | Record mantained devices</title>
            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                        ...
                        <?php }
                        if ($_SESSION['userpf@ttclassetsystem'] != '') { ?>
                    ...
                    <?php }
                    if ($_SESSION['userpf@ttclassetsystem'] === 90820 || $_SESSION['userpf@ttclassetsystem'] === 90128 || $_SESSION['userpf@ttclassetsystem'] === 91119 || $_SESSION['userpf@ttclassetsystem'] === 91019 || $_SESSION['userpf@ttclassetsystem'] === 91024) { ?>
                        <ul class="navbar-nav flex-column">
                            <li class="nav-item">
                        ...
                        <ul class="navbar-nav flex-column">
                            <li class="nav-item active">
                                ...
                                <ul id="mantain_drp" class="nav flex-column collapse show  collapse-level-1">
                                    <li class="nav-item">
                                        <ul class="nav flex-column">
                                            <li class="nav-item active">
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="#">Mantainance section</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Record mantained devices</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="link"></i></span></span>Record mantained devices.</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <!-- <h5 class="hk-sec-title">Coming soon</h5> -->
                        <!-- <p class="mb-40">Add advanced interaction controls to HTML tables like <code>search, pagination & selectors</code>. For responsive table just add the <code>responsive: true</code></p> -->
                        <!-- <div id="all-mantained-assets">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <p>Copyright &copy; <script>
                                ...
                                </script><a href="https://www.ttcl.co.tz/" target="_blank">TTCL</a> | All Rights Reserved</p>
                        </div>
                    </div>
                </footer>
            </div>
