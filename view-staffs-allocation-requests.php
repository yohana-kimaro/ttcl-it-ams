<?php 
session_start();
if ($_SESSION['userpf@ttclassetsystem'] === 90820||$_SESSION['userpf@ttclassetsystem'] === 90128||$_SESSION['userpf@ttclassetsystem'] === 91119) {
...
<head> 
    ...
    <title>TTCL IT AMS | IT Suport Supervisor staff's requests</title>
                ...
                <div class="navbar-nav-wrap">
                    ...
                    <ul class="navbar-nav flex-column">
                        <li class="nav-item active">
                            ...
                            <ul id="support_drp" class="nav flex-column collapse show collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="#">Support requests</a></li>
                    <li class="breadcrumb-item active" aria-current="page">View all staff's allocation requests</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="minimize"></i></span></span>Requests of staffs from ISS Manager to IT Support Supervisor for allocation.</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <div id="all-iss-allocation-requests">
