...
<head>
    ...
    <title>TTCL IT AMS | List of unallocated Laptops</title>
...
<body>
                                    ...
                                    <li class="nav-item">
                                        <ul class="nav flex-column">
                                            <li class="nav-item active">
                                                ...
                                                <ul id="view_it_drp1" class="nav flex-column show collapse collapse-level-2">
                                                    <li class="nav-item">
                                                        <ul class="nav flex-column">
                                                            <li class="nav-item">
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">View IT devices</a></li>
                    <li class="breadcrumb-item active" aria-current="page">View laptops</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="link"></i></span></span>List of unallocated Laptops.</h4>
                </div>
                <!-- /Title -->
    ...
    <script type="text/javascript">
      function userAvailability() {
        $("#loaderIcon").show();
        jQuery.ajax({
          url: "check/check_availability_till.php",
          data:'item-name1-comm10='+$("#item-name1-comm10").val(),
          type: "POST",
          success:function(data){
            $("#user-availability-statust1").html(data);
            $("#loaderIcon").hide();
          },
          error:function (){}
        });
