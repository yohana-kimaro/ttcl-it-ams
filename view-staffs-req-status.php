...
<head>
    ...
    <title>TTCL IT AMS | Direct Manager Status</title>
                ...
                <div class="navbar-nav-wrap">
                    ...
                    <ul class="navbar-nav flex-column">
                        <li class="nav-item active">
                            ...
                            <ul id="Components_drp" class="nav flex-column collapse show collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="#">Managing request</a></li>
                    <li class="breadcrumb-item active" aria-current="page">View staff's request status</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="file-text"></i></span></span>View staff's request status</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <div id="all-staffs-status-dept" class="table-responsive">
