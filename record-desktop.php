                        ...
                        <li class="nav-item active">
                            ...
                            <ul id="device_drp" class="nav flex-column collapse show collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="view-devices.php">View devices</a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <ul id="record_it_drp1" class="nav flex-column collapse collapse-level-2">
                                                <li class="nav-item">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="record-laptop.php"> Record Laptop</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="record-desktop.php">Record Desktop</a>
                                                        </li>
                                                        <li class="nav-item">
