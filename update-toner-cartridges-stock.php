        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update toner cartridges stock</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="credit-card"></i></span></span>Update toner cartridges stock</h4>
                </div>
                <!-- /Title -->
                                ...
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <!-- <div class="text-right mb-4">
                                            <button class="btn btn-dark btn-sm" id="add-toner-stock">Add new stock</button>
                                            <button class="btn btn-danger btn-sm" id="button">Delete stock</button>
                                        </div> -->
                                        <div id="all-update-toner-cartridge-stock">
