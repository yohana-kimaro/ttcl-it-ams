...
<head>
    ...
    <title>TTCL IT AMS | Staff allocated Toner cartridge</title>
                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        if ($_SESSION['userpf@ttclassetsystem'] != '') { ?>
                            ...
                            <li class="nav-item active">
                                ...
                                <ul id="toner_drp" class="nav flex-column collapse show  collapse-level-1">
                                    <li class="nav-item">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="#">Toner cartridges</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Allocated toner cartridges</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="printer"></i></span></span>Your allocated Toner cartridges</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <!-- <h5 class="hk-sec-title text-center mb-4"><strong>Toner catridge application status</strong></h5> -->
