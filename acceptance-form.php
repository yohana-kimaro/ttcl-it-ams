...
<head>
    ...
    <title>TTCL IT AMS | Acceptance form</title>
                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        if ($_SESSION['userpf@ttclassetsystem'] != '') { ?>
                            ...
                            <li class="nav-item active">
                                ...
                                <ul id="app_drp" class="nav flex-column collapse show collapse-level-1">
                                    <li class="nav-item">
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="#">Task to do</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Acceptace form</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="command"></i></span></span>Attach your acceptance form</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <div id="all-staff-acceptance-form">
