...
if($_SESSION['userpf@ttclassetsystem'] === 91119){
...
<head>
    ...
    <title>TTCL IT AMS | Finalize all staff's requests from IT Support supervisor</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Finalize all requests</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="file-text"></i></span></span>All staff's requests from IT Support Supervisor.</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <div id="all-it-manager-requests">
